...
contract _string{
    string str = "Hello";
                            // cakkdata is used for taking input. it similar to memory except that we cannot change the value of input in the function but in case of memory we can change the value
